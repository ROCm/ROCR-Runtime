...
typedef enum {
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_CB,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_CPF,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_DB,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_GRBM,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_GRBMSE,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_PASU,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_PASC,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_SPI,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_SQ,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_SQES,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_SQGS,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_SQVS,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_SQPS,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_SQLS,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_SQHS,
  ...
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_VGT,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_IA,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_MC,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_SRBM,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_TCS,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_WD,
  HSA_VEN_AMD_AQLPROFILE_BLOCK_NAME_CPG,
